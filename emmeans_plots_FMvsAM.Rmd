...
```{r}
mod_status_AMNMvsAM <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_status_AMNMvsAM.rds")
summary(mod_status_AMNMvsAM)
Anova(mod_status_AMNMvsAM)
performance::model_performance(mod_status_AMNMvsAM)
```

```{r}
#extract model means
means12 <- emmeans (mod_status_AMNMvsAM, ~ status , component = "response", cov.reduce = mean, data = dat)
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_means_AMNMvsAM.svg", plot=plot_mean_status_AMNMvsAM, width=10, height=8, scale = 0.5)

s12<- summary(mod_status_AMNMvsAM)
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_AMNMvsAM_env.svg", plot=plot_env_AMNMvsAM_status, width=10, height=7, scale = 0.5)
```
...
## with env variables
```{r}
mod_biome_AMNMvsAM <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_biome_AMNMvsAM.rds")
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_AMNMvsAM_status_ selectedbiomes_env.svg", plot=plot_env_AMNMvsAM_biome, width=10, height=7, scale = 0.5)
```
...
plot_AMNMvsAM2
#save
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_AMNMvsAM_status_biomes.png", plot=plot_AMNMvsAM2, width=15, height=7, scale = 0.5,  dpi = 300)

ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_AMNMvsAM_status_biomes.svg",plot=plot_AMNMvsAM2, width=15, height=7, scale = 0.5)
```
