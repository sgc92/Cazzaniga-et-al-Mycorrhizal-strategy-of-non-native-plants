...
```{r}
mod_global_AMNMvsNM <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/all_rar/mod_global_AMNMvsNM_rarall.rds")
summary(mod_global_AMNMvsNM)
Anova(mod_global_AMNMvsNM)
performance::model_performance(mod_global_AMNMvsNM)
```

```{r}
#extract model means
#means12 <- emmeans (mod_global_AMNMvsNM, ~ status , component = "response", cov.reduce = mean, data = dat)
means12 <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/all_rar/means_global_AMNMvsNM_rarall.rds")
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/all_rar/mod_global_means_AMNMvsNM_rar.svg", plot=plot_mean_status_AMNMvsNM, width=10, height=8, scale = 0.5)

s12<- summary(mod_global_AMNMvsNM)
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/all_rar/mod_global_AMNMvsNM_env_rar.svg", plot=plot_env_AMNMvsNM_status, width=10, height=7, scale = 0.5)
```
...
## with env variables
```{r}
mod_biome_AMNMvsNM <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/all_rar/mod_biome_AMNMvsNM_rarall.rds")
...
means32 <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/all_rar/means_biome_AMNMvsNM_rarall.rds")
#calculate significant differences
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/all_rar/mod_biome_AMNMvsNM_status_ selectedbiomes_env_rar.svg", plot=plot_env_AMNMvsNM_biome, width=10, height=7, scale = 0.5)
```
...
plot_AMNMvsNM2
#save
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/all_rar/mod_biome_difference_AMNMvsNM_status_biomes_rar.png", plot=plot_AMNMvsNM2, width=15, height=7, scale = 0.5,  dpi = 300)

ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/all_rar/mod_biome_difference_AMNMvsNM_status_biomes_rar.svg",plot=plot_AMNMvsNM2, width=15, height=7, scale = 0.5)
```
