...
```{r}
mod_status_AMNMvsALL <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_status_AMNMvsAM_NM.rds")
summary(mod_status_AMNMvsALL)
Anova(mod_status_AMNMvsALL)
performance::model_performance(mod_status_AMNMvsALL)
```

```{r}
#extract model means
means12 <- emmeans (mod_status_AMNMvsALL, ~ status , component = "response", cov.reduce = mean, data = dat)
...
plot_mean_status_FM
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_means_AMNMvsALL.svg", plot=plot_mean_status_FM, width=10, height=8, scale = 0.5)

s12<- summary(mod_status_AMNMvsALL)
...
plot_env_FM_status <- ggplot(df12, mapping =  aes(x = Estimate, y = env)) +
  ...
  theme_minimal()
plot_env_FM_status
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_AMNMvsALL_env.svg", plot=plot_env_FM_status, width=10, height=7, scale = 0.5)
```
...
## with env variables
```{r}
mod_biome_AMNMvsALL <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_biome_AMNMvsAM_NM.rds")
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_FMvsAll_status_ selectedbiomes_env.svg", plot=plot_env_FM_biome, width=10, height=7, scale = 0.5)
```
...
plot_FMall2
#save
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_AMNMvsALL_status_biomes.png", plot=plot_FMall2, width=15, height=7, scale = 0.5,  dpi = 300)

ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_AMNMvsALL_status_biomes.svg",plot=plot_FMall2, width=15, height=7, scale = 0.5)
```
