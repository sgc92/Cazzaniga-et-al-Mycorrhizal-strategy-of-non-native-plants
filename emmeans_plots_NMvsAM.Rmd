...
```{r}
mod_status_NMvsAM <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_status_NMvsAM.rds")
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_means_NMvsAM.svg", plot=plot_mean_status_NMvsAM, width=10, height=8, scale = 0.5)
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_NMvsAM_env.svg", plot=plot_env_NMvsAM_status, width=10, height=7, scale = 0.5)
```
...
## with env variables
```{r}
mod_biome_NMvsAM <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_biome_NMvsAM.rds")
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_NMvsAM_status_ selectedbiomes_env.svg", plot=plot_env_NMvsAM_biome, width=10, height=7, scale = 0.5)
```
...
plot_NMvsAM2
#save
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_NMvsAM_status_biomes.png", plot=plot_NMvsAM2, width=15, height=7, scale = 0.5,  dpi = 300)

ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_NMvsAM_status_biomes.svg",plot=plot_NMvsAM2, width=15, height=7, scale = 0.5)
```
