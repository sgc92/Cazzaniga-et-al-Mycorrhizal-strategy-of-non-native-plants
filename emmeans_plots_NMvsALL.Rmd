...
```{r}
mod_status_NMvsALL <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_status_NMvsALL.rds")
...
plot_mean_status_NM
#ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_means_NMvsALL.svg", plot=plot_mean_status_NM, width=10, height=8, scale = 0.5)
...
plot_env_NM_status <- ggplot(df12, mapping =  aes(x = Estimate, y = env)) +
  ...
  theme_minimal()
plot_env_NM_status
#ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_NMvsALL_env.svg", plot=plot_env_NM_status, width=10, height=7, scale = 0.5)
```
...
## with env variables
```{r}
mod_biome_NMvsALL <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_biome_NMvsALL.rds")
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_NMvsAll_status_ selectedbiomes_env.svg", plot=plot_env_NM_biome, width=10, height=7, scale = 0.5)
```
...
plot_NMall2
#save
#ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_NMvsALL_status_biomes.png", plot=plot_NMall2, width=15, height=7, scale = 0.5,  dpi = 300)

#ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_NMvsALL_status_biomes.svg",plot=plot_NMall2, width=15, height=7, scale = 0.5)

saveRDS(df_diff_NMall_biome_status, file = "C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/df_diff_NMall_biome_status.rds")
```
