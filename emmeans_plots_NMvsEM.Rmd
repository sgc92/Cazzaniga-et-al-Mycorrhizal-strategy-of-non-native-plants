...
```{r}
mod_status_NMvsEM <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_status_NMvsEM.rds")
summary(mod_status_NMvsEM)
Anova(mod_status_NMvsEM)
performance::model_performance(mod_status_NMvsEM)
```

```{r}
#extract model means
means12 <- emmeans (mod_status_NMvsEM, ~ status , component = "response", cov.reduce = mean, data = dat)
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_means_NMvsEM.svg", plot=plot_mean_status_NMvsEM, width=10, height=8, scale = 0.5)

s12<- summary(mod_status_NMvsEM)
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_status_NMvsEM_env.svg", plot=plot_env_NMvsEM_status, width=10, height=7, scale = 0.5)
```
...
## with env variables
```{r}
mod_biome_NMvsEM <- readRDS("C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Models/mod_biome_NMvsEM.rds")
...
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_NMvsEM_status_ selectedbiomes_env.svg", plot=plot_env_NMvsEM_biome, width=10, height=7, scale = 0.5)
```
...
plot_NMvsEM2
#save
ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_NMvsEM_status_biomes.png", plot=plot_NMvsEM2, width=15, height=7, scale = 0.5,  dpi = 300)

ggsave(file="C:/Users/sarag/OneDrive - ETH Zurich/1_Invasion/Inv_Data/sPlot4_Sara/Figures/mod_biome_difference_NMvsEM_status_biomes.svg",plot=plot_NMvsEM2, width=15, height=7, scale = 0.5)
```
